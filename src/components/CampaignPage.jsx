...
const EMAIL_TEMPLATES = [
  { id: 1,  name: 'Classic Newsletter',      tag: 'Newsletter',   tagColor: '#3b82f6', description: 'Clean header, body text, and a single CTA button.',       preview: { accent: '#f97316', layout: 'newsletter' } },
  { id: 2,  name: 'Bold Promo',              tag: 'Promotional',  tagColor: '#ef4444', description: 'Full-width hero banner with a large discount badge.',      preview: { accent: '#ef4444', layout: 'promo'      } },
  { id: 3,  name: 'Minimal Transactional',   tag: 'Transactional',tagColor: '#6b7280', description: 'Plain text style, high deliverability.',                  preview: { accent: '#6b7280', layout: 'minimal'    } },
  { id: 4,  name: 'Product Spotlight',       tag: 'Product',      tagColor: '#8b5cf6', description: 'Side-by-side product image and description.',              preview: { accent: '#8b5cf6', layout: 'product'    } },
  { id: 5,  name: 'Welcome Series',          tag: 'Onboarding',   tagColor: '#10b981', description: 'Warm welcome with step-by-step getting started guide.',    preview: { accent: '#10b981', layout: 'welcome'    } },
  { id: 6,  name: 'Re-engagement',           tag: 'Retention',    tagColor: '#f59e0b', description: 'We miss you style with a special offer.',                  preview: { accent: '#f59e0b', layout: 're-engage'  } },
  { id: 7,  name: 'Event Invite',            tag: 'Event',        tagColor: '#06b6d4', description: 'Elegant invite card with date, time, venue, and RSVP.',   preview: { accent: '#06b6d4', layout: 'event'      } },
  { id: 8,  name: 'Survey & Feedback',       tag: 'Survey',       tagColor: '#ec4899', description: 'Quick survey prompt with star rating and feedback link.',  preview: { accent: '#ec4899', layout: 'survey'     } },
  { id: 9,  name: 'Dark Mode Promo',         tag: 'Promotional',  tagColor: '#ef4444', description: 'High-contrast dark template with neon accents.',           preview: { accent: '#a78bfa', layout: 'dark'       } },
  { id: 10, name: 'Digest / Roundup',        tag: 'Digest',       tagColor: '#14b8a6', description: 'Multi-section layout for weekly digests and roundups.',    preview: { accent: '#14b8a6', layout: 'digest'     } },
]
...
function TemplateThumbnail({ layout, accent, selected }) {
  ...
  const thumbnails = {
    newsletter: (<><rect x="8" y="8" width="84" height="16" rx="3" fill={accent}/><rect x="34" y="13" width="32" height="5" rx="2" fill="white" opacity="0.7"/><rect x="8" y="28" width="84" height="22" rx="2" fill={textDark}/><rect x="30" y="34" width="40" height="4" rx="1" fill={textLight}/><rect x="8" y="55" width="84" height="3" rx="1" fill={textDark}/><rect x="8" y="61" width="70" height="3" rx="1" fill={textDark}/><rect x="8" y="67" width="78" height="3" rx="1" fill={textDark}/><rect x="28" y="75" width="44" height="10" rx="3" fill={accent}/><rect x="36" y="78" width="28" height="4" rx="1" fill="white" opacity="0.8"/><rect x="20" y="90" width="60" height="2" rx="1" fill={textLight}/></>),
    promo:      (<><rect x="8" y="8" width="84" height="35" rx="3" fill={accent}/><circle cx="50" cy="25" r="12" fill="white" opacity="0.2"/><rect x="42" y="21" width="16" height="8" rx="2" fill="white" opacity="0.6"/><rect x="18" y="48" width="64" height="5" rx="2" fill={textDark}/><rect x="28" y="56" width="44" height="3" rx="1" fill={textLight}/><rect x="16" y="64" width="68" height="12" rx="4" fill={accent}/><rect x="30" y="68" width="40" height="4" rx="1" fill="white" opacity="0.8"/><rect x="24" y="82" width="52" height="2" rx="1" fill={textLight}/><rect x="30" y="87" width="40" height="2" rx="1" fill={textLight}/></>),
    minimal:    (<><rect x="8" y="10" width="24" height="5" rx="2" fill={textDark}/><line x1="8" y1="20" x2="92" y2="20" stroke={textDark} strokeWidth="0.8"/><rect x="8" y="26" width="50" height="4" rx="1" fill={textDark}/><rect x="8" y="34" width="84" height="3" rx="1" fill={textLight}/><rect x="8" y="40" width="78" height="3" rx="1" fill={textLight}/><rect x="8" y="46" width="82" height="3" rx="1" fill={textLight}/><rect x="8" y="52" width="60" height="3" rx="1" fill={textLight}/><rect x="8" y="62" width="36" height="3" rx="1" fill={accent}/><rect x="8" y="74" width="30" height="3" rx="1" fill={textDark}/><rect x="8" y="80" width="42" height="2" rx="1" fill={textLight}/><line x1="8" y1="90" x2="92" y2="90" stroke={textLight} strokeWidth="0.8"/><rect x="28" y="93" width="44" height="2" rx="1" fill={textLight}/></>),
    product:    (<><rect x="8" y="8" width="84" height="8" rx="2" fill={textDark}/><rect x="34" y="10" width="32" height="4" rx="1" fill={textLight}/><rect x="8" y="20" width="38" height="38" rx="3" fill={textDark}/><circle cx="27" cy="36" r="10" fill={textLight}/><rect x="52" y="22" width="40" height="5" rx="2" fill={textDark}/><rect x="52" y="30" width="40" height="2.5" rx="1" fill={textLight}/><rect x="52" y="35" width="36" height="2.5" rx="1" fill={textLight}/><rect x="52" y="40" width="38" height="2.5" rx="1" fill={textLight}/><rect x="52" y="47" width="20" height="5" rx="1" fill={accent} opacity="0.2"/><rect x="53" y="49" width="14" height="3" rx="1" fill={accent}/><rect x="52" y="55" width="40" height="8" rx="3" fill={accent}/><rect x="60" y="58" width="24" height="3" rx="1" fill="white" opacity="0.8"/><rect x="8" y="70" width="84" height="2" rx="1" fill={textLight}/><rect x="8" y="75" width="84" height="2" rx="1" fill={textLight}/><rect x="24" y="85" width="52" height="2" rx="1" fill={textLight}/></>),
    welcome:    (<><rect x="8" y="8" width="84" height="24" rx="3" fill={accent}/><ellipse cx="50" cy="32" rx="46" ry="8" fill={bg}/><rect x="24" y="14" width="52" height="7" rx="2" fill="white" opacity="0.3"/>{[0,1,2].map(i=><g key={i}><circle cx="18" cy={50+i*14} r="5" fill={accent} opacity="0.8"/><rect x="28" y={47+i*14} width="56" height="3" rx="1" fill={textDark}/><rect x="28" y={52+i*14} width="44" height="2" rx="1" fill={textLight}/></g>)}<rect x="22" y="96" width="56" height="9" rx="3" fill={accent}/></>),
    're-engage': (<><rect x="8" y="8" width="84" height="28" rx="3" fill={accent} opacity="0.15"/><circle cx="50" cy="22" r="10" fill={accent} opacity="0.3"/><rect x="38" y="19" width="24" height="6" rx="2" fill={accent} opacity="0.5"/><rect x="16" y="42" width="68" height="6" rx="2" fill={textDark}/><rect x="8" y="52" width="84" height="3" rx="1" fill={textLight}/><rect x="8" y="58" width="70" height="3" rx="1" fill={textLight}/><rect x="22" y="66" width="56" height="14" rx="4" fill={accent} opacity="0.15"/><rect x="22" y="66" width="56" height="14" rx="4" stroke={accent} strokeWidth="1" fill="none"/><rect x="30" y="70" width="40" height="5" rx="1" fill={accent}/><rect x="16" y="85" width="68" height="10" rx="3" fill={accent}/><rect x="28" y="88" width="44" height="4" rx="1" fill="white" opacity="0.8"/></>),
    event:      (<><rect x="8" y="8" width="84" height="12" rx="3" fill={accent}/><rect x="14" y="16" width="72" height="68" rx="4" fill={white}/><rect x="22" y="24" width="56" height="7" rx="2" fill={textDark}/><rect x="22" y="36" width="20" height="20" rx="3" fill={accent} opacity="0.15"/><rect x="22" y="36" width="20" height="20" rx="3" stroke={accent} strokeWidth="1" fill="none"/><rect x="24" y="38" width="16" height="4" rx="1" fill={accent}/><rect x="26" y="44" width="12" height="8" rx="1" fill={textDark}/><rect x="48" y="38" width="34" height="3" rx="1" fill={textDark}/><rect x="48" y="44" width="28" height="2.5" rx="1" fill={textLight}/><rect x="48" y="49" width="30" height="2.5" rx="1" fill={textLight}/><rect x="22" y="62" width="56" height="10" rx="3" fill={accent}/><rect x="38" y="65" width="24" height="4" rx="1" fill="white" opacity="0.8"/><rect x="8" y="88" width="84" height="6" rx="2" fill={textLight}/></>),
    survey:     (<><rect x="8" y="8" width="84" height="14" rx="3" fill={accent} opacity="0.2"/><rect x="20" y="12" width="60" height="5" rx="2" fill={accent}/><rect x="8" y="28" width="68" height="5" rx="2" fill={textDark}/><rect x="8" y="36" width="84" height="2.5" rx="1" fill={textLight}/><rect x="8" y="41" width="70" height="2.5" rx="1" fill={textLight}/>{[0,1,2,3,4].map(i=><circle key={i} cx={26+i*10} cy="56" r="4" fill={i<3?accent:textLight}/>)}<rect x="8" y="64" width="24" height="2.5" rx="1" fill={textLight}/><rect x="68" y="64" width="24" height="2.5" rx="1" fill={textLight}/><rect x="20" y="72" width="60" height="10" rx="3" fill={accent}/><rect x="30" y="75" width="40" height="4" rx="1" fill="white" opacity="0.8"/><rect x="28" y="88" width="44" height="2" rx="1" fill={textLight}/><rect x="32" y="93" width="36" height="2" rx="1" fill={textLight}/></>),
    dark:       (<><rect x="8" y="8" width="84" height="20" rx="3" fill={accent} opacity="0.25"/><rect x="20" y="13" width="60" height="8" rx="2" fill={accent} opacity="0.7"/><line x1="8" y1="32" x2="92" y2="32" stroke={accent} strokeWidth="0.8" opacity="0.6"/><rect x="8" y="38" width="84" height="3" rx="1" fill="#4a4560"/><rect x="8" y="44" width="70" height="3" rx="1" fill="#4a4560"/><rect x="8" y="50" width="78" height="3" rx="1" fill="#4a4560"/>{[0,1,2].map(i=><rect key={i} x={8+i*28} y="60" width="24" height="18" rx="3" fill={accent} opacity={0.1+i*0.08}/>)}<rect x="20" y="84" width="60" height="10" rx="3" fill="none" stroke={accent} strokeWidth="1.5"/><rect x="28" y="87" width="44" height="4" rx="1" fill={accent} opacity="0.8"/></>),
    digest:     (<><rect x="8" y="8" width="84" height="10" rx="2" fill={accent}/><rect x="24" y="11" width="52" height="4" rx="1" fill="white" opacity="0.7"/>{[0,1,2].map(i=><g key={i}><rect x="8" y={23+i*22} width="84" height="18" rx="2" fill={textDark}/><rect x="12" y={27+i*22} width="40" height="4" rx="1" fill={textLight}/><rect x="12" y={33+i*22} width="56" height="2.5" rx="1" fill={textLight} opacity="0.5"/></g>)}<rect x="24" y="90" width="52" height="2" rx="1" fill={textLight}/></>),
  }
  ...
  return (
    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"
      ...
      {selected && (<><rect width="100" height="100" rx="4" fill={accent} opacity="0.08"/><rect width="100" height="100" rx="4" fill="none" stroke={accent} strokeWidth="2.5"/></>)}
    </svg>
  )
}
    ...
    <div
      ...
      style={{
        ...
        boxShadow: selected
          ...
          : hovered ? '0 4px 16px rgba(0,0,0,0.07)' : 'none',
      }}
    >
      <div style={{ width: '100%', aspectRatio: '1/1', background: 'var(--bg)', padding: '8px', boxSizing: 'border-box' }}>
        <TemplateThumbnail layout={template.preview.layout} accent={template.preview.accent} selected={selected}/>
      </div>
      <div style={{ padding: '10px 12px', borderTop: '1px solid var(--border)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '4px' }}>
          <span style={{
            fontSize: '11px', fontWeight: 600, padding: '2px 7px', borderRadius: '99px',
            background: template.tagColor + '18', color: template.tagColor, letterSpacing: '0.02em',
          }}>{template.tag}</span>
          {selected && (
            <span style={{
...
const toolbarBtns = [
  ...
  { label: 'H1', style: {} },
  { label: 'H2', style: {} },
  { label: null, style: {}, title: 'List',  icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg> },
  { label: null, style: {}, title: 'Link',  icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg> },
  { label: null, style: {}, title: 'Image', icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg> },
]
...
export default function CampaignPage() {
  ...
  const handleFileChange = (e) => {
    ...
    if (!file) return
    setCsvFile({ name: file.name, count: Math.floor(Math.random() * 9000) + 10000 })
  }
  ...
  const outerCols = isMobile || isTablet ? '1fr' : '1fr 1fr'
  const timeCols  = isMobile ? '1fr' : '1fr 1fr'
  const templateCols = isMobile ? 'repeat(2, 1fr)' : isTablet ? 'repeat(3, 1fr)' : 'repeat(5, 1fr)'

  return (
    <div style={{ display: 'grid', gridTemplateColumns: outerCols, gap: '20px' }}>
      ...
      <Card>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: timeCols, gap: '12px' }}>
          <div>
        ...
        {intervalText && (
          <div style={{
            ...
            <span style={{ flexShrink: 0, marginTop: '1px' }}>{icons.info}</span>
      ...
      <Card>
        ...
        >
          ...
          <div style={{ fontSize: '13px', color: 'var(--text-muted)' }}>
            {csvFile ? (
              <><strong style={{ color: 'var(--text-main)' }}>{csvFile.name}</strong><br/><span style={{ fontSize: '11.5px' }}>Click to replace</span></>
            ) : (
              <><strong style={{ color: 'var(--text-main)' }}>Click to upload</strong>{' or drag & drop'}<br/><span style={{ fontSize: '11.5px' }}>.CSV files only</span></>
            )}
          </div>
        </div>
      ...
      <Card style={{ gridColumn: '1 / -1' }}>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          {/* Toolbar: wraps naturally, CTA button drops to its own row on mobile */}
          <div style={{
            display: 'flex', gap: '4px', marginBottom: '8px',
            flexWrap: 'wrap', alignItems: 'center',
          }}>
            {toolbarBtns.map((btn, i) => <ToolbarBtn key={i} {...btn} />)}
            <button style={{
        ...
        <div style={{ borderTop: '1px solid var(--border)', paddingTop: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '6px', flexShrink: 0 }}>
              {['Select All', 'Clear'].map((label, i) => (
                <button key={label}
                  ...
                  onMouseEnter={e => {
                    e.currentTarget.style.borderColor = i === 0 ? 'var(--orange)' : 'var(--danger)'
                    e.currentTarget.style.color = i === 0 ? 'var(--orange)' : 'var(--danger)'
                  }}
                  onMouseLeave={e => {
          ...
          <p style={{ fontSize: '12.5px', color: 'var(--text-muted)', marginBottom: '14px', lineHeight: 1.5 }}>
            Select one or more templates. Your email content will be distributed randomly across all selected templates.
          </p>
          ...
          {selectedCount > 1 && (
            <div style={{
              ...
              <span style={{ display: 'flex', alignItems: 'center', color: 'var(--orange)', flexShrink: 0, marginTop: '1px' }}>{icons.shuffle}</span>
              <span>Recipients will be <strong>randomly assigned</strong> across <strong>{selectedCount} templates</strong> — each getting roughly <strong>{Math.round(100 / selectedCount)}%</strong> of the send volume.</span>
            </div>
          )}

          {/* Template grid */}
          <div style={{ display: 'grid', gridTemplateColumns: templateCols, gap: '12px' }}>
      ...
      <Card style={{ gridColumn: '1 / -1' }}>
        ...
        <button
          ...
          onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--orange)'; e.currentTarget.style.color = 'var(--orange)'; e.currentTarget.style.background = 'var(--orange-light)' }}
